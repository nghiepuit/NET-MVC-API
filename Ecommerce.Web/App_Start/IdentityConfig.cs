...
namespace Ecommerce.Web.App_Start
{
    ...
    {
        public ApplicationUserStore(EcommerceDbContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<EcommerceDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<EcommerceDbContext>()));
